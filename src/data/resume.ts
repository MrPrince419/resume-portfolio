const resumeData = {
  ...
  experience: [
    {
      ...
      description: [
        "Provided technical assistance to clients and employees",
        "Managed and maintained company's CRM system",
        "Implemented automation solutions for routine tasks"
      ]
    }
  ],
  education: [
  ...
  projects: [
    ...
    },
    {
      ...
      demoUrl: "https://mrprince419-voting-app.netlify.app/",
    ...
    },
    {
      ...
      demoUrl: "https://mrprince419-calendar-app.netlify.app/",
    ...
    },
    {
      ...
      demoUrl: "https://mrprince-calorie-calculator-app.netlify.app/",
